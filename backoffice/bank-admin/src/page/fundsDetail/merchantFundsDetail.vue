<template>
  <main class="fillcontain clear">
    ...
    <section class="main">
      ...
      >
        <el-table-column align="center" prop="date" label="商户"> </el-table-column>
        <el-table-column align="center" prop="name" label="系统订单号"> </el-table-column>
        <el-table-column align="center" prop="address" label="变动前总余额"> </el-table-column>
        <el-table-column align="center" prop="address" label="变动前可用余额">
        </el-table-column>
        <el-table-column align="center" prop="address" label="变动前在途余额">
        </el-table-column>
        <el-table-column align="center" prop="address" label="变动前冻结余额">
        </el-table-column>
        <el-table-column align="center" prop="address" label="交易金额"> </el-table-column>
        <el-table-column align="center" prop="address" label="变动后总余额"> </el-table-column>
        <el-table-column align="center" prop="address" label="变动后可用余额">
        </el-table-column>
        <el-table-column align="center" prop="address" label="变动后在途余额">
        </el-table-column>
        <el-table-column align="center" prop="address" label="变动后冻结余额">
        </el-table-column>
